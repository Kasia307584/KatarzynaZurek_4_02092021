...
document.querySelector(".btn-submit").addEventListener("click", function (e) {
  ...
  if (!firstNameInput.validity.valid) {
    // fonction validity permet de verifier si l'utilisateur a saisi le champs de l'input en accord avec les propietés ds HTML, ici: minlength:2 et requiered
    isValid = false;
  ...
  if (!termsCheckbox.checked) {
    // function checked permet de verifier si la case est cochée
    isValid = false;
